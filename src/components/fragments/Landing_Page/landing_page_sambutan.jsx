            ...
            <div className="flex justify-center">
                <div className="flex flex-row items-center gap-10 w-full max-w-5xl">
                    <div className="flex-shrink-0">
                        <img src="/images/logo-sidenreng-rappang.png" alt="Logo Kelurahan" className="bg-white w-64 h-64 object-contain drop-shadow-md rounded-full"
                        />
                    </div>

                    <div className="flex-1">
                        <h2 className="text-4xl font-bold text-red-700 mb-2">Sambutan Kepala Kelurahan</h2>
                        <h3 className="text-xl font-bold text-gray-800 tracking-wider">HAIRUDDIN</h3>
                        <p className="text-sm font-medium text-gray-600 mb-4">Kepala Kelurahan Rijang Pittu</p>
                        <p className="font-semibold mb-2">Assalamu Alaikum Warohmatullahi Wabarakatuh.</p>
